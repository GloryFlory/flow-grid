...
function SignUpForm() {
  ...
  const planFromUrl = searchParams.get('plan')?.toUpperCase() || 'FREE'
        ...
        <Card className="w-full max-w-md text-center">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-600 mb-4">
              Welcome to Flow Grid! You're being signed in automatically...
            </p>
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-gray-600">
            {planFromUrl === 'PRO' ? 'Start your Pro trial' : 
             planFromUrl === 'ENTERPRISE' ? 'Get started with Enterprise' : 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={isLoading}>
              {isLoading ? (
                ...
                `Create ${planFromUrl === 'FREE' ? 'Free' : planFromUrl} Account`
              )}
            </Button>
          </form>
