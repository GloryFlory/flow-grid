            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Session views</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <Link href={`/admin/festivals/${festival.id}/sessions`}>
                  <div className="p-4 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Add, edit, and organize your workshops</p>
                      </div>
                ...
                <Link href={`/admin/festivals/${festival.id}/info`}>
                  <div className="p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Update dates, location, and description</p>
                      </div>
            ...
            <Card>
              ...
              <CardContent>
                <Link href={`/admin/festivals/${festival.id}/analytics`}>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <Link href={`/admin/festivals/${festival.id}/branding`}>
                  <div className="p-4 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div>
                ...
                <Link href={`/admin/festivals/${festival.id}/teacher-photos`}>
                  <div className="p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-semibold text-gray-900">Teacher Photos</h3>
                        <p className="text-sm text-gray-600">Upload photos for this festival's teachers</p>
                      </div>
            ...
            <Card>
              ...
              <CardContent>
                <Link href={`/admin/festivals/${festival.id}/settings`}>
