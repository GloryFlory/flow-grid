      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-xl text-gray-600">
            Empowering event organizers to create beautiful, professional schedules with ease
          </p>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-8 mb-12">
            ...
            <p className="text-lg text-gray-700 mb-4">
              We believe that every event, workshop, and gathering deserves a beautiful, professional online presence. 
            ...
            <p className="text-lg text-gray-700">
              Our mission is simple: make it effortless for event organizers to create stunning, 
          ...
          <p className="text-gray-700 mb-4">
            ...
            event organizers face when trying to present their events professionally online. Too many amazing 
            events were stuck with:
          </p>
          ...
          <p className="text-gray-700 mb-4">
            We knew there had to be a better way. Event organizers pour their hearts into creating incredible 
          ...
          <p className="text-gray-700 mb-6">
            ...
            beautiful, modern design their events deserve.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="border-l-4 border-blue-200 pl-6">
              ...
              <p className="text-gray-700">
                Event organizing is complex enough. We believe technology should make your life easier, 
            ...
            <div className="border-l-4 border-green-200 pl-6">
              ...
              <p className="text-gray-700">
                Your event is unique and special. Our designs ensure your event looks professional 
            ...
            <div className="border-l-4 border-purple-200 pl-6">
              ...
              <p className="text-gray-700">
                We're part of the event community ourselves. We understand the challenges you face 
            ...
            <div className="border-l-4 border-orange-200 pl-6">
              ...
              <p className="text-gray-700">
                Great events come in all sizes and budgets. We're committed to keeping Flow Grid 
          ...
          <p className="text-gray-700 mb-4">
            ...
            for event organizers who want to:
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-1 text-sm text-gray-700">
                  <li>• Quick event setup in minutes</li>
          ...
          <p className="text-gray-700 mb-4">
            Since launching, Flow Grid has helped event organizers around the world create beautiful, 
          ...
          <blockquote className="border-l-4 border-gray-300 pl-6 italic text-gray-700 mb-8">
            "Flow Grid transformed how we present our event online. What used to take weeks of website 
            development now takes minutes, and the result looks more professional than anything we could 
            have built ourselves."
            <footer className="text-sm text-gray-600 mt-2">— Event Organizer, Europe</footer>
          </blockquote>
          */}
          ...
          <p className="text-gray-700 mb-6">
            ...
            developers, and event enthusiasts who understand the community we serve because we're part of it.
          </p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Interested in joining our mission to make event organizing easier and more beautiful? 
          ...
          */}
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
            ...
            <li>Multi-language support for international events</li>
          ...
          <p className="text-gray-700 mb-8">
            ...
            simple, beautiful, and accessible to event organizers everywhere.
          </p>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
              Whether you're organizing your first workshop or your fiftieth event, 
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 text-center">
            <p className="text-gray-600">
              ...
              With love for the global event community ❤️
            </p>
          </div>
        </div>
      </div>
