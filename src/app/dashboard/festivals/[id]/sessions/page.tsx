            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                  <h4 className="font-medium text-amber-900 text-sm mb-1 flex items-center gap-1">
                  ...
                  <p className="text-xs text-amber-800">
                    If columns aren't separated properly, use <strong>File → Import</strong> instead of double-clicking the CSV file.
                  </p>
                </div>
              </CardContent>
            </Card>
